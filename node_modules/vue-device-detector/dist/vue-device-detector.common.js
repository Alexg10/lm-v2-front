...
function () {
  function DeviceDetector() {
    ...
    this.iphoneX = this.iphone && devicePixelRatio === 3 && window.screen.width === 375 && window.screen.height === 812;
    this.iPhoneXR = this.iphone && devicePixelRatio === 2 && window.screen.width === 414 && window.screen.height === 896;
    this.iPhoneXSMax = this.iphone && devicePixelRatio === 3 && window.screen.width === 414 && window.screen.height === 896;
  ...
  DeviceDetector.prototype.find = function (needle) {
...
/******/ });
//# sourceMappingURL=vue-device-detector.common.js.map